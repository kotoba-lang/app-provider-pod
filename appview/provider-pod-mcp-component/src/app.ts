// provider-pod.etzhayyim.com — Provider Pod Registry & Health Management Platform
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 8 methods: registerProvider / listProviders / getProvider / updateHealth /
//            listCapabilities / createPod / listPods / getPodStatus
...
const NSID_PREFIX = "com.etzhayyim.apps.providerPod.";
const ACTOR_DID = "did:web:provider-pod.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "pht0hl9x",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "60-apps/etzhayyim-project-provider-pod/bpmn",
        methods: [
          "registerProvider", "listProviders", "getProvider", "updateHealth",
          "listCapabilities", "createPod", "listPods", "getPodStatus",
        ],
      });
    }
